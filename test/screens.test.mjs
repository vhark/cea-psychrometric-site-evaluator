...
const sunny=(hours=48)=>({schemaVersion:1,source:'Synthetic clear-sky fixture',sourceKind:'test',latitude:36.15,longitude:-95.99,latitude:40,longitude:-100,timezone:'UTC',startDate:'2025-07-01',endDate:'2025-07-02',
...
const cold=(hours=48,tempC=-5)=>({schemaVersion:1,source:'Synthetic cold fixture',sourceKind:'test',latitude:36.15,longitude:-95.99,latitude:40,longitude:-100,timezone:'UTC',startDate:'2025-01-01',endDate:'2025-01-02',
 hours:Array.from({length:hours},(_,i)=>({time:Date.UTC(2025,0,1,i),tempC,rh:.7,pressurePa:98500,ghiWm2:0}))});

const house=(over={})=>({...makeScenario('greenhouseDouble'),latitude:40,longitude:-100,timezone:'UTC',name:'Screen fixture',coolingKW:150,coolingCOP:3,dehuKgH:30,
...
const box=(over={})=>({...makeScenario('indoor'),latitude:40,longitude:-100,timezone:'UTC',name:'Heat source fixture',areaM2:100,canopyM2:100,heightM:4,
...
const humid=(hours=48)=>({schemaVersion:1,source:'Synthetic warm-humid fixture',sourceKind:'test',latitude:25.77,longitude:-80.19,latitude:40,longitude:-100,timezone:'UTC',startDate:'2025-07-01',endDate:'2025-07-02',
  hours:Array.from({length:hours},(_,i)=>{const h=i%24,sun=Math.max(0,Math.sin(Math.PI*(h-6)/12));
...
const ventLimited=(over={})=>({...makeScenario('greenhouseDouble'),latitude:40,longitude:-100,timezone:'UTC',name:'Insect screen fixture',
