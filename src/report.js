...
export const STYLE = `:root{color-scheme:light;--ground:#F7FAF6;--panel:#FDFEFD;--panel-2:#EDF2EC;--panel-3:#E5EBE3;--ink:#23271E;--ink-2:#5C6759;--ink-3:#838E80;--line:#E2E7E0;--line-2:#D2DACF;--accent:#2E6B43;--leaf:#5E9643;--spring:#5E9643;--summer:#E3A237;--autumn:#9B6FA8;--winter:#869A3A;--ok:#2E7D46;--warn:#B0721A;--bad:#C0392B;--paper:var(--panel);--pine:var(--accent)}:root[data-theme="dark"]{color-scheme:dark;--ground:#10130D;--panel:#191E15;--panel-2:#212819;--panel-3:#2A3222;--ink:#E9EDE1;--ink-2:#A7B098;--ink-3:#7C8770;--line:#2C3323;--line-2:#3A4230;--accent:#57A46C;--leaf:#6FB24A;--spring:#6FB24A;--summer:#E6AE4F;--autumn:#B892C8;--winter:#A6B94F;--ok:#57A46C;--warn:#E6AE4F;--bad:#C0392B;}*{box-sizing:border-box}body{background:var(--ground);color:var(--ink);font:15px/1.6 "Hanken Grotesk",sans-serif;max-width:1100px;margin:auto;padding:40px 32px}.mark{display:flex;align-items:center;gap:12px;font:800 16px/1.2 "Hanken Grotesk",sans-serif;margin-bottom:32px}.mark small{display:block;font-weight:500;font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-3)}h1,h2,h3{font-family:"Young Serif",serif;font-weight:400;line-height:1.2}h1{font-size:clamp(2rem,5vw,3.3rem)}h2{font-size:1.5rem}.cat,.meta,.foot,summary{font:12px/1.6 "Spline Sans Mono",monospace;color:var(--ink-2)}.cat{display:block;margin-bottom:8px}p{max-width:80ch}section{margin:36px 0;padding-top:24px;border-top:1px solid var(--line)}table{width:100%;border-collapse:collapse}th,td{padding:9px 8px;border-bottom:1px solid var(--line);text-align:left;vertical-align:top;overflow-wrap:anywhere}th{font:500 12px "Hanken Grotesk",sans-serif}td,pre{font:12px/1.6 "Spline Sans Mono",monospace;font-variant-numeric:tabular-nums}pre{white-space:pre-wrap;overflow-wrap:anywhere}.notice,.verdict{border:1px solid var(--line-2);background:var(--panel-2);padding:16px;border-radius:10px}a{color:var(--accent)}.foot{margin-top:40px}@media(max-width:600px){body{padding:24px 16px}table{display:block;overflow-x:auto}}`;
export const shell = (title, cat, body, extraStyle = '') => `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>CEA Psychrometric Site Evaluator | ${escapeHTML(title)} | One Season Farmers</title><link href="https://fonts.googleapis.com/css2?family=Young+Serif&family=Hanken+Grotesk:wght@400;500;600;700;800&family=Spline+Sans+Mono:wght@400;500;600&display=swap" rel="stylesheet"><style>${STYLE}${extraStyle}</style><svg width="0" height="0" style="position:absolute" aria-hidden="true">
  <symbol id="pw" viewBox="0 0 100 100">
    <g>
      <path class="p" fill="var(--spring)" d="M50,50 C41,33 45,15 58,7 C63,21 60,37 50,50 Z"/>
      <path class="p" fill="var(--summer)" d="M50,50 C67,41 85,45 93,58 C79,63 63,60 50,50 Z"/>
      <path class="p" fill="var(--autumn)" d="M50,50 C59,67 55,85 42,93 C37,79 40,63 50,50 Z"/>
      <path class="p" fill="var(--winter)" d="M50,50 C33,59 15,55 7,42 C21,37 37,40 50,50 Z"/>
      <path class="p" fill="var(--spring)" opacity=".55" d="M50,50 C50,32 63,20 79,20 C77,36 66,48 50,50 Z"/>
      <path class="p" fill="var(--summer)" opacity=".55" d="M50,50 C68,50 80,63 80,79 C64,77 52,66 50,50 Z"/>
      <path class="p" fill="var(--autumn)" opacity=".55" d="M50,50 C50,68 37,80 21,80 C23,64 34,52 50,50 Z"/>
      <path class="p" fill="var(--winter)" opacity=".55" d="M50,50 C32,50 20,37 20,21 C36,23 48,34 50,50 Z"/>
      <circle cx="50" cy="50" r="5.4" fill="var(--paper)"/>
      <circle cx="50" cy="50" r="2.6" fill="var(--pine)"/>
    </g>
  </symbol>
</svg><div class="mark"><svg class="pinwheel" width="36" height="36" aria-hidden="true"><use href="#pw"/></svg><span>One Season Farmers<small>Climate screening</small></span></div><span class="cat">${escapeHTML(cat)}</span><h1>CEA Psychrometric Site Evaluator</h1>${body}<p class="foot">One Season Farmers · Model ${escapeHTML(MODEL_VERSION)} · Generated ${escapeHTML(new Date().toISOString())}</p></html>`;
...
.facts div{background:var(--ground);padding:12px 14px}.facts dt{font:500 9px 'Spline Sans Mono',monospace;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-2);margin-bottom:5px}
.facts dd{margin:0;font:13px 'Spline Sans Mono',monospace;font-variant-numeric:tabular-nums;overflow-wrap:anywhere}
.pdf{font:500 11px 'Spline Sans Mono',monospace;letter-spacing:.14em;text-transform:uppercase;background:var(--accent);color:var(--ground);border:1px solid var(--accent);border-radius:4px;padding:11px 20px;cursor:pointer}
...
figcaption{font:11px 'Spline Sans Mono',monospace;color:var(--ink-2);margin:8px 0 12px;max-width:80ch}
.legend{list-style:none;padding:0;display:flex;flex-wrap:wrap;gap:6px 18px;font:11px 'Spline Sans Mono',monospace;margin:0 0 12px}
...
td.k{font:500 11px 'Hanken Grotesk',sans-serif;color:var(--ink-2)}.data td,.data th{padding:6px 8px;font-size:12px}
...
@media print{
 ...
 .page-foot{display:block;margin-top:10mm;padding-top:3mm;font:8pt 'Spline Sans Mono',monospace;color:var(--ink-2);border-top:1px solid var(--ink-2);break-inside:avoid}
 ...
 a[href^="http"]::after{content:" (" attr(href) ")";font:8pt 'Spline Sans Mono',monospace;overflow-wrap:anywhere}
...
export function reportHTML(results, snapshot, {aggregate = null, sites = null, siteRuns = []} = {}) {
  ...
  const body = [
    ...
    section('Cost and attainment basis', `${results.map(r => interp([r.scenario.name, costBasisText(r.summary.costBasis), capitalBasisText(r.scenario)])).join('')}${compared.slice(1).map(row => interp([attainmentComparisonText(compared[0], row), `${row.operatingCostReduction?.label || row.operatingCostDifference.label}: ${money(row.operatingCostReduction?.amount ?? row.operatingCostDifference.amount)} for ${row.name} versus baseline ${compared[0].name}.`, costBasisText(row.costBasis)])).join('')}`),
...
<details open><summary>Model assumptions</summary><pre>${escapeHTML(JSON.stringify(primary.assumptions || {}, null, 2))}</pre></details>`)}</div>`,
    `<p class="page-foot">${escapeHTML(`One Season Farmers · CEA Psychrometric Site Evaluator · Model ${primary.modelVersion || MODEL_VERSION} · ${site} · Generated ${generatedAt}`)}</p>`
  ].join('');
