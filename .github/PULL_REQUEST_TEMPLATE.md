...
- [ ] Operating costs retain period/population, numeric applied prices, exclusions and separate capital; attainment differences use pp with both endpoints.
- [ ] Schema changes migrate supported inputs, reject unsupported versions and discard imported result claims.
- [ ] UI/document changes follow One Season Farmers Instrument/Field rules and use current screenshots from `site/assets/screenshots/`, not historical captures.
...
- [ ] `CHANGELOG.md` updated in the appropriate release section (or Unreleased if present)
