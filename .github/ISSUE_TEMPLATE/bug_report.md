...
**Weather:** bundled Tulsa example / NASA POWER retrieval / station observations / imported file (delete as appropriate). If retrieved, give the location and date range.
