...
Grownetics Archive document. Generator model 0.3.0-screening; scenario schema 2, weather snapshot schema 1. No indoor simulation or operating-cost estimate is performed.
